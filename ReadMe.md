...
- **Landing Page**: The initial interface of the app where users can start the camera or upload a photo.
- **Successful Authentication**: A welcome message and user photo are displayed for recognized employees.
- **Failed Authentication**: A clear message and uploaded photo are shown for unrecognized users.
